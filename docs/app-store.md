...
- **Subtitle** (30 max): `Send it to your desktop shelf`
  ...
  "Mac". The description and review notes may still say Mac, because there it
  is a factual compatibility statement, which the trademark guidelines allow.
...
| **5.2.5 Apple trademark in metadata** — happened, 2026-08-19 | "Mac" in the **subtitle**. Metadata-only fix: a subtitle with no Apple product name, same build, resubmit. Name, subtitle and icon stay trademark-free; body copy that states compatibility ("the Mac half is a separate app") is allowed and stayed. |
