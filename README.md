...
Or on Nix: add `github:hausfold/perch` as a flake input — `overlays.default`
...
- [`ai/SKILL.md`](ai/SKILL.md) — the agent surface: drop it in and *"put this in my shelf"* works first try
