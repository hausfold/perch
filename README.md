...
- **it lives in Finder's right-click menu** — enable **Add to Perch Shelf** once in System Settings ▸ General ▸ Login Items & Extensions ▸ Finder, then send selected files or folders straight to the shelf from Finder's Quick Actions menu. Perch must be running so it can reserve shelf space before Finder copies anything.
