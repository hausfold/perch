...
`morsel-icon-master.png` is the 1254×1254 source used to generate the native
macOS app-icon slots. It was generated with OpenAI's built-in image generation
tool from this prompt:

> Create a refined native Mac utility icon for Morsel, a temporary file shelf
...
The files in `Morsel/Assets.xcassets/AppIcon.appiconset` are mechanically scaled
