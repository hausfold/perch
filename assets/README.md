...
When a nebelung token moves, swap it in every SVG here, re-render both dark PNGs
and the iOS icon, then regenerate the macOS icon slots from
`perch-icon-master.png`. resvg is what the committed PNGs were checked against;
